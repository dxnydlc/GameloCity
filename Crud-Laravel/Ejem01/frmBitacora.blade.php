...
<form action="" id="frmDocumento" autocomplete="off" >
    ...
    <textarea name="Glosa" id="Glosa" class=" form-control " style="display: none;" ></textarea>
        ...
        <div class=" col-lg-10 col-md-10 " >
            <div class="box box-primary " >
                ...
                <div class="box-body" >
                    ...
                    <div class=" row " >
                        ...
                        <div class=" col-lg-3 col-md-3 " >
                            <div class="form-group">
                                ...
                                <input type="date" name="Fecha" id="Fecha" class="form-control" value="{{ FECHA_MYSQL }}">
                            </div>
                            <!-- ./form-group -->
                        </div>
                        <!-- ./col -->
                    ...
                    <!-- ./row -->
                    <hr>
                    <textarea id="Glosa2" rows="10" cols="80" ></textarea>
                    <hr>
