...
<section class="content"  >
    ...
    <div id="wrapper_form" style="display:none;" >
        <?= $this->include( '/asistencias_25/asistencia_eventos/frmAEventos' ) ?>
    </div>
...
<script type="text/javascript" src="<?= esc($APP_URL) ?>librerias/asistencias_25/asistencia_eventos/homeAEventos.js?v=<?= $VERSION ?>" ></script>
