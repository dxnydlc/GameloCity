                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                <br>
                                <p>Estamos enviado tu ${data.Categoria} correspondiente al mes ${data.Mes}-${data.Anio} por favor recuerda que esta información es confidencial.
                                <br/>
                                ...
                                Para poder ver tu boleta has click en el siguiente enlace, muchas gracias por tu atención.
                                </p>
                            </td>
                        </tr>
                    </tbody></table>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                <h3>Hola ${usuario.name},</h3>
                                <br>
                                <p>Estamos enviado tu contrato de trabajo correspondiente al mes ${data.Mes}-${data.Anio} por favor recuerda que esta información es confidencial.
                                <br/>
                                Para poder ver tu contrato laboral has click en el siguiente enlace, muchas gracias por tu atención.
                                </p>
                            </td>
                        </tr>
                    </tbody></table>
...
var mail_capacitacion = ( titulo , _textoPre , data , det , link , _FechaHoraReu , mapita ) => {
    ...
    if( data.LinkRepositorio ){
        _archivosRepo = `<br>Revisa el material adicional aquí:<br><a target="_blank" href="${data.LinkRepositorio}" >Ver material</a>`;
    }
    return `
    <!doctype html>
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        ...
                        <tr>
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" >
                                ...
                                <br>
                                <p>El área : ${data.Area_Org} esta organizando la capacitación ${data.Tipo} <strong>${data.Titulo}</strong></p>
                                <p>Dirigida al área: ${data.Area_Rec}</p>
                                <p>La cual se llevará a cabo en: ${data.Cliente} - ${data.Local} / ${data.Direccion}</p>
                                ${mapita}
                                ...
                                ${_archivosRepo}
								<br/>
								Contamos con tu participación, recuerda que estás capacitaciones son importantes, muchas gracias por su atención.
                                </p>
                            </td>
                        </tr>
                        </tbody>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h4>Solicitud de atención de equipo</h4>
                            <h1>${_Data.Codigo}.</h1>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #009FC7;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                            <!-- GAAAAAAAAAAAA -->
                                <!-- <a class="mcnButton " title="Ver el ticked de atención de maquina." href="" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Ver el ticked de atención de maquina.</a> -->
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        ...
                        <tr>
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" >
                                ...
                                <br>
                                <p>El área de mantenimiento ha asignado un técnico para su atención de la solicitud :<strong>${data.Codigo}</strong></p>
                                <p>El técnico asignado es: ${data.Tecnico} el cual se aproximará en fecha: ${_FechaAtencion}, en horario: ${data.AteInicio}-${data.AteFin}</p>
                                <p>Observaciónes del técnico:</p>
                                <br/>
                                ${data.Observaciones}
								<br/>
