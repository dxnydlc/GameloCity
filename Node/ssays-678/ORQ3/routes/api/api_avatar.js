...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    var arExt = $ext.split('/');
    cb(null, 'AVATAR_ORIGIN_'+Date.now() + '.'+arExt[1] ) //Appending .jpg
  }
});
...
router.post('/photos/upload/:q', uploadCarpeta.single('formData'), async (req, res) => {
  ...
  $dataInsert.formulario      = 'FOTO_PERFIL2';
