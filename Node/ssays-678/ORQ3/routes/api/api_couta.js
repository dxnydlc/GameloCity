...
const { docVentaCuotaModel,User } = require('../../db');
...
//////////////////////////////////////////////////////////
router.post('/', [
    check('MontoPagoCuota' ,'Ingrese monto.').not().isEmpty(),
    ...
    await docVentaCuotaModel.create(req.body)
    .catch(function (err) {
    ...
    var _dataGuardado = await docVentaCuotaModel.findOne({
        where : {
            uu_id : req.body.uu_id
        }
    });

    $response.item = await docVentaCuotaModel.findOne({
        where : {
            uu_id : req.body.uu_id
        }
    });
...
router.post('/get_data', async (req,res)=>{
    ...
    $response.data = await docVentaCuotaModel.findOne({
        where : {
            uu_id : req.body.uuid
        }
    })
...
router.put('/:uuid', [
	...
	await docVentaCuotaModel.update(req.body,{
		where : { 
...
router.delete('/:uuid', async (req,res)=>{
    ...
    var _Entidad = await docVentaCuotaModel.findOne({
        where : {
            uu_id : req.body.uuid
        }
    })
	...
	await docVentaCuotaModel.destroy({
		where : { 
            uu_id : req.params.uuid 
        }
    })
