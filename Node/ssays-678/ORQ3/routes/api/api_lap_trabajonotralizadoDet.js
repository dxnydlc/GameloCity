...
// api_lap_trabajonotralizadoDet.js
...
const { LapTrabajoNoRealizadoDetModel, xlsLAPIncidenciasDetModel, User, sequelize, archiGoogleModel, sucursalModel } = require('../../db');
...
async function execQuery( _where , _limit  )
{
    ...
    //
    _dataResp = await LapTrabajoNoRealizadoDetModel.findAll({
...
router.post('/', _Requeridos ,async (req,res)=>{
    ...
    try {
        ...
        _response.item = await LapTrabajoNoRealizadoDetModel.findOne({
            where : {
                uu_id : req.body.uu_id
            }
        });
...
router.post('/get_data', async (req,res)=>{
    ...
    try {
        //
        var _Entidad = await LapTrabajoNoRealizadoDetModel.findOne({
            where : {
                uu_id : req.body.uuid
            }
        })
...
router.put('/:uuid', _Requeridos , async (req,res)=>{
    ...
    try {
        ...
        _response.data = [];
        //
        await LapTrabajoNoRealizadoDetModel.update(req.body,{
            where : { 
...
router.delete('/:uuid', async (req,res)=>{
    ...
    try {
        ...
        var $userData = await helpersController.getUserData( req.headers['api-token'] );
        //
        await LapTrabajoNoRealizadoDetModel.destroy({
            where : { 
                uu_id : req.params.uuid 
            }
        })
